...
# from tokenizers import RobertaTokenizer
...
class DataTrainingArguments:
    ...
    dataset_config_name: Optional[str] = field(
        default="wikitext-103-v1", metadata={"help": "The configuration name of the dataset to use (via the datasets library)."}
    )
...
def main():
    ...
    #     tokenizer.train(trainer=trainer,files=files)
    #     #tokenizer = RobertaTokenizer()
    else: 
        raise ValueError(
